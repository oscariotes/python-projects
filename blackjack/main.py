...
def game():
    ...
    def calculate_score(user_cards, computer_cards):
        ...
        if sum(computer_cards) == 21 and len(computer_cards) == 2:
            ...
            return
        if 11 in user_cards and len(user_cards) == 2 and sum(user_cards) > 21:
            user_cards.remove(11)
            user_cards.append(1)
        if 11 in computer_cards and len(computer_cards) == 2 and sum(computer_cards) > 21:
    ...
    while True:
        ...
        if draw_card == 'y':
            ...
            if sum(computer_cards) < 17:
                computer_cards.append(deal_card())
                print(f'Computer\'s card: {computer_cards}')
            print(calculate_score(user_cards, computer_cards), sum(user_cards), sum(computer_cards))
            break
        else:
            print(f'Your cards: {user_cards}')
            #computer_cards.append(deal_card())
